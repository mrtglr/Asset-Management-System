...
namespace assetManagementBackend.DTOS
{
    public class Helper
    {
        ...
        //LOG GENERATOR
        public static void createLog(AssetContext _context, bool log_situation, int user_id, string process, string statement)
        {        
